...
{include uri='design:content/datatype/edit/ezobjectrelationlist_controls.tpl'}
    ...
    <div class="input-group">
        ...
        <span class="input-group-btn">
            <button type="submit" class="button hide ezobject-relation-search-btn btn btn-sm btn-info btn-sm" name="CustomActionButton[{$attribute.id}_browse_objects]"><i class="fa fa-search"></i></button>
        </span>
    </div>
    </div>
    </div>
