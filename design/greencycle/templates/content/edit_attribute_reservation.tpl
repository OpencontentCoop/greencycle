...
{def $is_owner = cond(eq($object.owner_id, fetch(user, current_user).contentobject_id), true(), false())}

<div class="Grid Grid--withGutter u-padding-top-xxl u-padding-bottom-xxl">
    <div class="Grid-cell u-sizeFull u-sm-size12of12 u-padding-bottom-xxl">
            ...
            {foreach $content_attributes_grouped_data_map as $attribute_group => $content_attributes_grouped}
                ...
                <div id="accordion-panel-{$attribute_group}"
                    ...
                    {foreach $content_attributes_grouped as $attribute_identifier => $attribute}                        
                        <div {if and($is_owner, array('acceptance_rejection','expiration')|contains($attribute_identifier))}style="display:none"{/if}>
