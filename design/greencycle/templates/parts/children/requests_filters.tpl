...
{def $limitation = hash(
    'accessWord', 'limited', 
    'policies', array(
        hash('Class', array(520), 'StateGroup_request', array(14))
    )
)}
...
{else}
    ...
    {def $children_count = fetch( openpa, concat( 'list_count' ), hash( 'parent_node_id', $node.node_id, 'limitation', $limitation['policies'], 'class_filter_type', 'include', 'class_filter_array', array('request') ) )}
    {if $children_count}
      <div class="content-view-children">
        {foreach fetch( openpa, 'list', hash( 'parent_node_id', $node.node_id,
                                                ...
                                                'class_filter_type', 'include', 'class_filter_array', array('request'),
