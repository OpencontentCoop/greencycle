...
<p>{'We inform you that the entered reservation has been refused'|i18n('editorialstuff/mail')} <a href="{$post.object.main_node.url_alias|ezurl(no,full)}">{$post.object.name|wash()}</a></p>
